from risk import BreastCancer, MhtStatus, canrisk_file_from_json, extract_cancer_rates, CanRisk, gail_from_json
...
def get_baseline(age = 0, age_at_menarche = 0, age_at_first_child = 0, oral_contra = True, 
                   breast_biop = 0, hyperplasia = 0, mother = 0, sister = 0,
                   height = 0, weight = 0, alcohol = 0):
